 ...
 * @return
 */
    private int runTruncate(boolean overridePropertiesFile, String[] argv) {
        ...
        System.out.printf("*************************************\n");
        System.out.printf("*** Java TPC-C Data Truncater version " + Tpcc.VERSION + " ***\n");
        System.out.printf("*************************************\n");
...
//                stmt.execute("SET FOREIGN_KEY_CHECKS=0");
            ...
            System.out.printf("TPCC truncate Table Started...\n");
...
//                 stmt.close();
                ...
                System.out.printf("\n...TPCC truncate Table  COMPLETED SUCCESSFULLY.\n");
            } catch (Exception e) {
        	...
        	ConnectionManager.close(conn, stmt, null,true);
        	logger.error("", e);
            throw new RuntimeException("Connection error", e);
        }  finally {
        	ConnectionManager.close(conn, stmt, null,false);
        }
