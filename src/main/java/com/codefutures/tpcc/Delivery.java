...
//                    rs.close();
                ...
                if (TRACE)
                    logger.trace("SELECT o_c_id FROM orders WHERE o_id = " + no_o_id + " AND o_d_id = " + d_id + " AND o_w_id = " + w_id);
                try {
...
//                    rs.close();
                ...
                if (TRACE)
                    logger.trace("UPDATE order_line SET ol_delivery_d = " + currentTimeStamp.toString() + " WHERE ol_o_id = " + no_o_id + " AND ol_d_id = " + d_id + " AND ol_w_id = " + w_id);
                try {
